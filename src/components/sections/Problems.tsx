...
export default function Problems() {
  return (
    <section id="problemas" className="relative py-24 bg-transparent overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Grid de 4 Tarjetas de Problemas */}
          ...
          {problems.map((problem, index) => {
            return (
              <motion.div
                ...
                className="group relative p-8 rounded-3xl bg-[#1a1c26]/60 border border-white/[0.08] hover:border-white/[0.15] transition-all duration-300 backdrop-blur-xl shadow-2xl flex flex-col justify-between"
              >
                <div>
                  {/* Comilla de cita en color acento */}
                  <div className="mb-3">
                    <span className="text-4xl font-serif text-[#ff4d6d] leading-none block">
                      ”
                    </span>
                  </div>
                ...
                <div className="pt-2 flex items-center">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#36151d]/90 border border-rose-500/30 text-xs font-medium text-rose-300">
